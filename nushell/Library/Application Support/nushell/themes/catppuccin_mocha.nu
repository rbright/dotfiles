...
# Define syntax highlighting scheme
let scheme = {
...
# Apply color_config.shape_external_resolved color to external commands
$env.config.highlight_resolved_externals = true

# Configure colors for the explore command
$env.config.explore = {
